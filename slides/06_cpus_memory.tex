...
mov [ebx], eax
  ...
  \begin{frame}[fragile]
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.55\linewidth]{figures/cpu_pipeline_bubbles.png}
    \end{figure}
...
add ecx, 1
  ...
  \begin{frame}[fragile]
    ...
    \begin{itemize}
      \item \emph{temporal locality}, i.e., algorithms that reuse data before discarding it, or
